...
print(
    F"User Graph Model >> Data feed from: {model.mongo_db_connector.collection_name}")
...
print("User Graph Model >> Summary statistics of cross validation using 3 different scoring techniques")
print(model_statistics)

print(F"User Graph Model >> Drawing histograms using combinations of 3 different scoring techniques")
